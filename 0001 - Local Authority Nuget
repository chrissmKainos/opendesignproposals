...
#### Sub task 1: New service solution & Nuget
A new solution and project will be created containing an exact copy of the code in use by the existing He.Htb.Apply.Application project. The structure of this will be:
* __Repo__: he.htb.apply
* __Solution name__: He.Htb.Apply.Services
...
* Replace any references to the removed LocalAuthorityService with the new nuget package (within the He.Htb.Apply solution)
